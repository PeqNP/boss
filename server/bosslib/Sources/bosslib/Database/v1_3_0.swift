...
class Version1_3_0: DatabaseVersion {
    ...
    func update(_ session: Database.Session) async throws {
        ...
        try await sql.create(table: "lines")
            ...
            .column("inherit_shifts", type: .smallint, .default(0), .notNull)
            // ViewState
            ...
            .column("is_parallel", type: .smallint, .default(0), .notNull)
        ...
        try await sql.create(table: "operator_absences")
            ...
            .column("operator_id", type: .int)
            .column("shift_id", type: .int)
            .column("entire_shift", type: .smallint, .default(0), .notNull)
        ...
        try await sql.create(table: "supply_field_options")
            ...
            .column("name", type: .text)
            .column("hidden", type: .smallint, .default(0), .notNull)
        ...
        try await sql.create(table: "work_units")
            ...
            .column("name", type: .text)
            .column("on_hold", type: .smallint, .default(0), .notNull)
        ...
        try await sql.create(table: "work_unit_notification_triggers")
            ...
            .column("event_intake_queue", type: .smallint, .default(0), .notNull)
            .column("event_station", type: .smallint, .default(0), .notNull)
            .column("event_operation", type: .smallint, .default(0), .notNull)
            .column("event_output", type: .smallint, .default(0), .notNull)
            .foreignKey(["work_unit_id"], references: "work_units", ["id"], onDelete: .cascade)
            .run()
        ...
        try await sql.create(table: "work_unit_supplies")
            ...
            .column("waivable", type: .smallint, .default(0), .notNull)
            .column("waived", type: .smallint, .default(0), .notNull)
            .foreignKey(["work_unit_id"], references: "work_units", ["id"], onDelete: .cascade)
