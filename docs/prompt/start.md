...
- The public BOSS API is located at `/public/boss/*.js`. Any application may interact with OS features using:
  - `os`: Provides OS-level functions
  - `os.network`: Provides API to make calls to backend services
  - `os.notification`: Provides routing of app events and displays notifications
